...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/casillas/academia/research/in_progress/empathy_intonation_perc/exp/empathy_intonation_perc/empathy_intonation_perc.py',
